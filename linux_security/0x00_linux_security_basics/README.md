0-login: a bash script that show you the last 5 logins session for users with their corresponding dates.
...
7-scan: a bash script that scan a subnetwork to discover live host using scan.